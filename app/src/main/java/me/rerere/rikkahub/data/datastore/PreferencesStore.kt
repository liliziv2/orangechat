...
data class DisplaySetting(
    ...
    fun toAppearanceSnapshot(
        ...
        // 以下为 FX 线独有的外观字段，预设必须一并快照，否则切换预设会把玻璃观感抹平
        materialMode = materialMode,
        liquidGlassBubbles = liquidGlassBubbles,
        chatBubbleRealtimeBlur = chatBubbleRealtimeBlur,
        interfaceRealtimeRendering = interfaceRealtimeRendering,
        interfaceBlurRadius = interfaceBlurRadius,
        interfaceSurfaceOpacity = interfaceSurfaceOpacity,
        popupSurfaceOpacity = popupSurfaceOpacity,
        drawerSurfaceOpacity = drawerSurfaceOpacity,
        chatAvatarMode = chatAvatarMode,
        showTopBarDualAvatar = showTopBarDualAvatar,
        showUserBubble = showUserBubble,
        showDateTimeInMessage = showDateTimeInMessage,
        settingsBackgroundPath = settingsBackgroundPath,
    )
    ...
    fun applyAppearanceSnapshot(snapshot: AppearanceSnapshot): DisplaySetting = copy(
        ...
        liquidGlassBubbles = snapshot.liquidGlassBubbles,
        chatBubbleRealtimeBlur = snapshot.chatBubbleRealtimeBlur,
        interfaceRealtimeRendering = snapshot.interfaceRealtimeRendering,
        interfaceBlurRadius = snapshot.interfaceBlurRadius,
        interfaceSurfaceOpacity = snapshot.interfaceSurfaceOpacity,
        popupSurfaceOpacity = snapshot.popupSurfaceOpacity,
        drawerSurfaceOpacity = snapshot.drawerSurfaceOpacity,
        chatAvatarMode = snapshot.chatAvatarMode,
        showTopBarDualAvatar = snapshot.showTopBarDualAvatar,
        showUserBubble = snapshot.showUserBubble,
        showDateTimeInMessage = snapshot.showDateTimeInMessage,
        settingsBackgroundPath = snapshot.settingsBackgroundPath,
    )
